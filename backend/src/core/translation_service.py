...
class CityTranslationService:
    ...
    CITY_TRANSLATIONS: Dict[str, str] = {
        ...
        "области jetysu": "Жетисуская область",
        "области zhetysu": "Жетисуская область",
        "области актобе": "Актюбинская область",
        "области aktobe": "Актюбинская область",
        "области атырау": "Атырауская область",
        "области atyrau": "Атырауская область",
        "области караганда": "Карагандинская область",
        "области karaganda": "Карагандинская область",
        "области костанай": "Костанайская область",
        "области kostanay": "Костанайская область",
        "области кызылорда": "Кызылординская область",
        "области kyzylorda": "Кызылординская область",
        "области мангистау": "Мангыстауская область",
        "области mangystau": "Мангыстауская область",
        "области павлодар": "Павлодарская область",
        "области pavlodar": "Павлодарская область",
        "области акмола": "Акмолинская область",
        "области akmola": "Акмолинская область",
        "области жетысу": "Жетисуская область",
        "области jetysu": "Жетисуская область",
        "области zhetysu": "Жетисуская область",
