...
- Handle "области [название]" format: "области Жетысу" -> "Жетисуская область", "области Актобе" -> "Актюбинская область", "области Атырау" -> "Атырауская область"
- All oblast names must end with "-ая область" (e.g., "Карагандинская область", "Алматинская область")
