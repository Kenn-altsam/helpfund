...
class KGDDataImporter:
    ...
    async def ensure_tax_columns_exist(self):
        ...
        try:
            ...
            AND column_name IN ('tax_2020', 'tax_2021', 'tax_2022', 'tax_2023', 'tax_2024', 'tax_2025', 'annual_tax_paid', 'last_tax_update')
            """
            ...
            print("✅ Tax columns verified/created")
            
        except Exception as e:
            print(f"❌ Error ensuring tax columns exist: {e}")
            raise
    ...
    async def batch_update_companies(self, tax_data_list: List[Dict], batch_size: int = 50) -> Dict[str, int]:
        ...
        print(f"🚀 Starting batch update of {total} companies...")
        ...
        for i in range(0, total, batch_size):
            ...
            for j, tax_data in enumerate(batch):
                ...
                if not has_tax_data:
                    print(f"⏭️  Skipping {bin_number} - no tax data")
                    skipped += 1
                    continue
                ...
                if success:
                    successful += 1
                    print(f"✅ Updated {bin_number} - {company_name}")
                else:
                    failed += 1
                    print(f"❌ Failed {bin_number} - {error_msg}")
    ...
    async def import_tax_data(self, csv_file: Optional[Path] = None):
        ...
        try:
            ...
            print(f"📁 Logs saved to: {KGD_DATA_DIR}")
...
async def get_database_stats():
    ...
    try:
        ...
        print(f"📊 Database Tax Data Statistics:")
