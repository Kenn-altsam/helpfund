...
Проведи поиск в интернете по запросу "благотворительная деятельность компании {company_name} Казахстан" и составь краткую, но информативную сводку на основе найденной информации.

ЗАДАЧА:
1. Определи, есть ли достоверные доказательства благотворительной деятельности компании.
2. Если есть - кратко опиши конкретные примеры (что делали, кому помогали, когда, суммы, если указаны).
3. Если информация недостаточна или неясна, или если прямых доказательств нет, честно об этом скажи.
...
- Фокусируйся на конкретных фактах и доказательствах.
- Если найдены только общие фразы о социальной ответственности без деталей, так и укажи.
"""
