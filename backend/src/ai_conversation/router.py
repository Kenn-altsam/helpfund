...
async def get_company_charity_info(
    ...
    try:
        ...
        Обрати внимание: если среди ссылок есть посты из социальных сетей (например, Instagram, Facebook, Twitter, VK, Telegram и т.д.), обязательно учти их содержание при анализе.
