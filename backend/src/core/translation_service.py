...
class CityTranslationService:
    ...
    CITY_TRANSLATIONS: Dict[str, str] = {
        # Сокращения областей Казахстана
        "вко": "Восточно-Казахстанская область",
        "вко область": "Восточно-Казахстанская область",
        ...
        "ско область": "Северо-Казахстанская область",
        ...
        "зко область": "Западно-Казахстанская область",
