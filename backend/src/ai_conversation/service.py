...
Пример 1g: Поиск по области в форме "области [название]"
История: []
...
Ожидаемый JSON:
{
  ...
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана область 'Жетысу' в форме 'области Жетысу', преобразовал в каноническую форму 'Жетисуская область'. Ключевые слова: крупные. Количество по умолчанию 10, страница 1.",
  "preliminary_response": "Ищу крупные компании в Жетисуской области. Пожалуйста, подождите..."
}

Пример 1h: Поиск по области Актобе
История: []
...
Ожидаемый JSON:
{
  ...
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана область 'Актобе' в форме 'области Актобе', преобразовал в каноническую форму 'Актюбинская область'. Ключевые слова: IT. Количество по умолчанию 10, страница 1.",
