...
class CityTranslationService:
    ...
    CITY_TRANSLATIONS: Dict[str, str] = {
        ...
        "zhetysu region": "Жетысуская область",
        "zhetysu oblast": "Жетысуская область",
        "zhetysu": "Жетысуская область",
        "jetysu region": "Жетысуская область",
        "jetysu oblast": "Жетысуская область",
        ...
        "turkestan oblast": "Туркестанская область",
