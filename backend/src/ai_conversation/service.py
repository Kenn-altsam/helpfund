...
ПРАВИЛА:
- **Локация:** Город или область всегда должны быть на русском языке (например, "Almaty" -> "Алматы"). Если пользователь пишет склонённую или неофициальную форму города или области (например, "в Алмате", "из Астаны", "в Улытауской области"), ты ОБЯЗАН преобразовать её в официальный вид (например, "Алматы", "Астана", "Улытауская область"). Для областей всегда используй полную каноническую форму с "область" (например, "Улытауская область", "Алматинская область", "Актюбинская область"). Если город или область не указаны ни в текущем сообщении, ни в истории, `location` должен быть `null`.
...
Пример 1b: Поиск по области
История: []
Пользователь: "Найди 15 компаний в Улытауской области"
Ожидаемый JSON:
{
  "intent": "find_companies",
  ...
  "quantity": 15,
  "page_number": 1,
  "reasoning": "Указана область 'Улытауской области', преобразовал в каноническую форму 'Улытауская область'. Количество 15, страница 1.",
  "preliminary_response": "Ищу 15 компаний в Улытауской области. Пожалуйста, подождите..."
}

Пример 1c: Поиск по области с ключевыми словами
История: []
Пользователь: "Найди IT компании в Алматинской области"
Ожидаемый JSON:
{
  "intent": "find_companies",
  ...
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана область 'Алматинской области', преобразовал в каноническую форму 'Алматинская область'. Ключевые слова: IT. Количество по умолчанию 10, страница 1.",
  "preliminary_response": "Ищу IT компании в Алматинской области. Пожалуйста, подождите..."
}

Пример 1d: Поиск по Жетисуской области
История: []
Пользователь: "Найди 20 компаний в Жетысуской области"
Ожидаемый JSON:
{
  "intent": "find_companies",
  ...
  "quantity": 20,
  "page_number": 1,
  "reasoning": "Указана область 'Жетысуской области', преобразовал в каноническую форму 'Жетисуская область'. Количество 20, страница 1.",
  "preliminary_response": "Ищу 20 компаний в Жетисуской области. Пожалуйста, подождите..."
}

Пример 1e: Поиск по сокращенной форме области
История: []
Пользователь: "10 крупных компаний области Жетысу"
Ожидаемый JSON:
{
  "intent": "find_companies",
  "location": "Жетисуская область",
  "activity_keywords": ["крупных"],
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана сокращенная форма области 'Жетысу', преобразовал в каноническую форму 'Жетисуская область'. Ключевые слова: крупных. Количество 10, страница 1.",
  "preliminary_response": "Ищу 10 крупных компаний в Жетисуской области. Пожалуйста, подождите..."
}

Пример 2: Запрос на продолжение (город)
История: [
...
Пример 2a: Запрос на продолжение (область)
История: [
  {"role": "user", "content": "Найди 20 компаний в Улытауской области"},
  {"role": "assistant", "content": "Отличные новости! Я нашел информацию...", "parsed_intent": {"intent": "find_companies", "location": "Улытауская область", "activity_keywords": null, "quantity": 20, "page_number": 1}}
]
Пользователь: "дай еще"
Ожидаемый JSON:
{
  ...
  "page_number": 2,
  "reasoning": "Запрос на продолжение. Взял location, activity_keywords и quantity из `parsed_intent` предыдущего ответа ассистента в истории. Увеличил страницу до 2.",
  "preliminary_response": "Конечно! Ищу следующую группу из 20 компаний в Улытауской области. Подождите, пожалуйста."
}

Пример 2b: Запрос на продолжение (Жетисуская область)
История: [
  {"role": "user", "content": "Найди 15 компаний в Жетысуской области"},
  {"role": "assistant", "content": "Отличные новости! Я нашел информацию...", "parsed_intent": {"intent": "find_companies", "location": "Жетисуская область", "activity_keywords": null, "quantity": 15, "page_number": 1}}
]
Пользователь: "дай еще"
Ожидаемый JSON:
{
  ...
  "page_number": 2,
  "reasoning": "Запрос на продолжение. Взял location, activity_keywords и quantity из `parsed_intent` предыдущего ответа ассистента в истории. Увеличил страницу до 2.",
  "preliminary_response": "Конечно! Ищу следующую группу из 15 компаний в Жетисуской области. Подождите, пожалуйста."
}

Пример 3: Третий запрос на продолжение (город)
История: [
  {"role": "user", "content": "Найди 15 IT компаний в Almaty"},
  {"role": "assistant", "content": "Отличные новости! Я нашел информацию...", "parsed_intent": {"intent": "find_companies", "location": "Алматы", "activity_keywords": ["IT"], "quantity": 15, "page_number": 1}},
...
Пример 3a: Третий запрос на продолжение (область)
История: [
  {"role": "user", "content": "Найди 25 компаний в Актюбинской области"},
  {"role": "assistant", "content": "Отличные новости! Я нашел информацию...", "parsed_intent": {"intent": "find_companies", "location": "Актюбинская область", "activity_keywords": null, "quantity": 25, "page_number": 1}},
  {"role": "user", "content": "дай еще"},
  {"role": "assistant", "content": "Конечно! Ищу следующую группу...", "parsed_intent": {"intent": "find_companies", "location": "Актюбинская область", "activity_keywords": null, "quantity": 25, "page_number": 2}}
]
Пользователь: "дай еще"
Ожидаемый JSON:
{
  ...
  "page_number": 3,
  "reasoning": "Запрос на продолжение. Взял location, activity_keywords и quantity из `parsed_intent` предыдущего ответа ассистента в истории. Увеличил страницу до 3.",
  "preliminary_response": "Конечно! Ищу следующую группу из 25 компаний в Актюбинской области. Подождите, пожалуйста."
}
"""
