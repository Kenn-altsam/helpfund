...
- **Области:** Для областей используй правильные названия: "области Жетысу" -> "Жетысуская область", "области Актобе" -> "Актюбинская область", "области Атырау" -> "Атырауская область". Все области должны заканчиваться на "ская область".
...
{
  "intent": "find_companies",
  "location": "Жетысуская область",
  "activity_keywords": ["крупных"],
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана область 'Жетысу', преобразовал в официальный вид 'Жетысуская область'. Ключевые слова: крупных. Количество 10, страница 1.",
  "preliminary_response": "Ищу 10 крупных компаний в Жетысуской области. Пожалуйста, подождите..."
}
...
Ожидаемый JSON:
{
  ...
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана область 'Актобе', преобразовал в официальный вид 'Актюбинская область'. Количество 10, страница 1.",
