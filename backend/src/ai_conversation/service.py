...
- **Области:** Для областей всегда используй каноническую форму с окончанием "-ая область" (например, "Жетисуская область", "Актюбинская область", "Атырауская область"). ВАЖНО: "Жетысу" → "Жетисуская область" (с "и", не "ы"), "Актобе" → "Актюбинская область".
...
Пример 1b: Область с сокращенным названием
История: []
...
Ожидаемый JSON:
{
  ...
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана сокращенная форма области 'Жетысу', преобразовал в каноническую форму 'Жетисуская область' (с 'и', не 'ы'). Ключевые слова: крупных. Количество 10, страница 1.",
  "preliminary_response": "Ищу 10 крупных компаний в Жетисуской области. Пожалуйста, подождите..."
}

Пример 1c: Область с названием города
История: []
Пользователь: "Найди компании области Актобе"
Ожидаемый JSON:
{
  "intent": "find_companies",
  ...
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана область с названием города 'Актобе', преобразовал в каноническую форму 'Актюбинская область'. Количество 10, страница 1.",
  "preliminary_response": "Ищу компании в Актюбинской области. Пожалуйста, подождите..."
}

Пример 1d: Склонённая форма города в предложении
История: []
Пользователь: "найди мне 15 компаний в Алмате"
Ожидаемый JSON:
{
  "intent": "find_companies",
  "location": "Алматы",
  ...
  "quantity": 15,
  "page_number": 1,
  "reasoning": "Город указан в склонённой форме 'в Алмате', преобразовал в официальный вид 'Алматы'. Количество 15, страница 1.",
  "preliminary_response": "Ищу 15 компаний в Алматы. Пожалуйста, подождите..."
}

Пример 1e: Область с количеством и ключевыми словами
История: []
...
Ожидаемый JSON:
{
  ...
  "quantity": 5,
  "page_number": 1,
  "reasoning": "Указана область 'Улытауской области', преобразовал в каноническую форму 'Улытауская область'. Ключевые слова: крупных. Количество 5, страница 1.",
  "preliminary_response": "Ищу 5 крупных компаний в Улытауской области. Пожалуйста, подождите..."
}

Пример 1f: Область с сокращенным названием
История: []
...
Ожидаемый JSON:
{
  ...
  "quantity": 10,
  "page_number": 1,
  "reasoning": "Указана сокращенная форма области 'области Абай', преобразовал в каноническую форму 'Абайская область'. Ключевые слова: крупных. Количество 10, страница 1.",
  "preliminary_response": "Ищу 10 крупных компаний в Абайской области. Пожалуйста, подождите..."
}
