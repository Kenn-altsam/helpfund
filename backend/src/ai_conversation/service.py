...
Используя свои знания и доступ к информации в интернете, найди информацию о благотворительной деятельности компании "{company_name}" в Казахстане и составь подробную сводку.

ЗАДАЧА:
1. Определи, есть ли достоверные доказательства благотворительной деятельности компании.
2. Если есть, подробно опиши основные направления и конкретные примеры благотворительности (что делали, кому помогали, когда, суммы, если доступны).
3. Представь информацию в формате, подобном списку или абзацам, если это уместно для ясности, аналогично тому, как это показано в примере ниже.
4. Если информации недостаточно, она неясная или носит общий характер без конкретики - честно об этом скажи, объясни возможные причины отсутствия подробной информации (например, не публичная деятельность).
5. Используй информативный и профессиональный тон.

ВАЖНО:
- Не выдумывай информацию, которой нет в источниках.
- Фокусируйся на фактах и доказательствах.
- Если компания НЕ ведет публичную благотворительность или детали не раскрываются, это тоже важная информация, которую нужно упомянуть.

Пример желаемого формата ответа (если информация найдена):
"Компания 'Пример' активно занимается благотворительной деятельностью, что является частью ее корпоративной социальной ответственности. Вот основные направления их благотворительности:
• Помощь детям-сиротам и шефство над детскими учреждениями: Компания оказывает поддержку детским домам, например, в 2022 году выделила средства на ремонт детского дома №5 в Алматы.
• Поддержка малообеспеченных граждан: Регулярно спонсирует образовательные программы для детей из малообеспеченных семей.
• Спонсорство общественных организаций: Поддерживает различные социальные проекты через общественные организации.
• Помощь в чрезвычайных ситуациях: В 2023 году выделила 50 миллионов тенге на помощь пострадавшим от наводнения в Атырауской области."

Пример ответа при недостатке информации:
"В открытых источниках найдено мало конкретной информации о благотворительной деятельности компании '{company_name}'. Упоминания носят общий характер или отсутствуют. Возможно, компания не ведет публичную благотворительную деятельность или ее социальные проекты не освещаются в интернете."
"""
